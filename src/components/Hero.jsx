        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold leading-[1.1] mb-6 text-dark-slate">
              The <span className="text-tunisian-blue">Hidden Gem</span>{' '}
              Everyone In Leeds Keeps Talking About
            </h1>

            <p className="text-lg md:text-xl text-gray-600 mb-10 max-w-xl leading-relaxed">
              Inspired by his mother&apos;s home cooking, Chef Mokhles discovered
              his passion for food at a young age. He later refined his skills
              in France, learning from experienced Tunisian chefs and mastering
              authentic techniques. Today, he brings that experience to
              England, creating traditional dishes with quality ingredients,
              passion, and a deep respect for his heritage.
            </p>

            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="#menu"
                className="bg-tunisian-blue text-white px-8 py-4 rounded-full font-extrabold text-lg shadow-xl shadow-tunisian-blue/20 hover:bg-dark-navy transition-all flex items-center justify-center space-x-2 group"
              >
              ...
              <a
                href="#location"
                className="bg-soft-white text-dark-slate border-2 border-gray-200 px-8 py-4 rounded-full font-extrabold text-lg hover:bg-dark-navy hover:text-white transition-all flex items-center justify-center space-x-2"
              >
            ...
            <div className="mt-10">
              ...
              <p className="text-sm font-bold text-dark-slate mb-3">
                {submitted
          ...
          >
            ...
            <div className="absolute -bottom-6 -left-6 z-20 bg-pure-white p-6 rounded-3xl shadow-2xl max-w-[240px] animate-bounce-slow">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <span className="font-bold text-sm text-dark-slate">
                  Fresh Everyday
                </span>
              </div>

              <p className="text-xs text-gray-500">
                Our legendary bread is baked fresh every single morning in the
                market.
              </p>
            </div>
          </motion.div>
